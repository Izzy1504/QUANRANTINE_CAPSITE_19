        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 mt-3 shadow-none border-radius-xl" id="navbarTop">
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb" class="Dashboard">
                    ...
                    <h6 class="font-weight-bolder mb-0">CAMP SITE QUARANTINE</h6>
                </nav>
...
<!-- =========================================================================================================================== -->
                    ...
                    <div class="container border-radius-lg">
                        <div class="row">
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"><?php echo $data['p']?></h4>
                            ...
                            <div class="col-3 py-3 ps-0">
                                ...
                                <h4 class="font-weight-bolder"><?php echo $data['pd']?></h4>
                                <div class="progress w-75">
                            ...
                            <div class="col-3 py-3 ps-0">
                                <div class="d-flex mb-2">
                                    ...
                                    <p class="text-xs mt-1 mb-0 font-weight-bold">Số người trong tình trạng cảnh báo</p>
                                </div>
                                <h4 class="font-weight-bolder"><?php echo $data['pw']?></h4>
                                <div class="progress w-75">
    ...
    <table>
        ...
        <?php 
        foreach($data['warning'] as $item => $warning){
        ?>  
         <tr>
            <td><?php echo $warning->getPatientId()?></td>
            <td><?php echo $warning->getDate()->format('Y-m-d')?></td>
            <td><?php echo $warning->getReason()?></td>
            <td><?php if( $warning->getStatus()==0){
