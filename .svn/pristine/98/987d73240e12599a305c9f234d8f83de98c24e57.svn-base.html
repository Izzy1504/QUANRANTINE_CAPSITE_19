<head>
    ...
    <link rel="stylesheet" href="app/views/assets/css/theme.css">
    <link rel="stylesheet" href="app/views/assets/css/loopple/loopple.css">
    <link rel="stylesheet" href="app/views/room/room.css">
<style>
    .footer {
        display: flex;
                  ...
                  <?php
                    foreach($data['room'] as $item => $room){
                      ?>
                        ...
                        <td><?php if($room->getUsed() < $room->getQuantity()) echo 'available';
                                  else echo 'not available';
                        ?></td>
                        <td><?php echo $room->getUsed().'/'.$room->getQuantity()?></td>
                    </tr>
                      <?php
                    }
                  ?>
