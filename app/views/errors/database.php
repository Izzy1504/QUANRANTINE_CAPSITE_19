...
<body class="bg-purple">
        ...
        <div class="stars">
            ...
            <div class="central-body">
                <h1 style="font-size: 100px; color: white;">Database Connection Error</h1>
                <p style="font-size: 50px; color: white;">We're sorry, but something went wrong. Please try again later.</p>
            </div>
            <div class="objects">
